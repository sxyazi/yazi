...
impl<'a> Folder<'a> {
	#[inline]
	pub fn parent(cx: &'a yazi_core::Ctx) -> Self { Self { cx, kind: 0 } }

	#[inline]
	pub fn current(cx: &'a yazi_core::Ctx) -> Self { Self { cx, kind: 1 } }

	#[inline]
	pub fn preview(cx: &'a yazi_core::Ctx) -> Self { Self { cx, kind: 2 } }
}
